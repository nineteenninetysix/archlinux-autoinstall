...
This has not been updated in many years and most likely will not work out of the box on the newest arch ISOs.
Also nowadays ArchLinux provide an [official automated installation tool](https://wiki.archlinux.org/title/Archinstall).
...
AUTHOR:
[tsvetkov96](https://github.com/nineteenninetysix) || August 2021
